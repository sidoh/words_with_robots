...
public class MinimaxIterativeDeepening extends WordsWithFriendsMoveGenerator {
  private static final Logger LOG = LoggerFactory.getLogger(MinimaxIterativeDeepening.class);

  private final WordsWithFriendsMoveGenerator inner;
  private static final GameStateHelper stateHelper = new GameStateHelper();
  private static final int MOVE_HELPER_SIZE = 100;
  private static final int MIN_SCORE = 10;
  private static final int BRANCHING_FACTOR_LIMIT = 10;
  ...
  public MinimaxIterativeDeepening(WordsWithFriendsMoveGenerator inner) {
    this.inner = inner;
  }
  ...
  protected AlphaBetaClosure alphaBetaSearch(AlphaBetaClosure closure) {
    ...
    for (Move move : moves) {
      ...
      if ( move.getResult().getScore() < MIN_SCORE && movesConsidered > 0 ) {
      ...
      if ( movesConsidered >= BRANCHING_FACTOR_LIMIT ) {
        break;
      }
